			...
			<div id="stickerside">
				<div class="sidebar fix" >
						<ul>
							...
							<li><span class="spcl"><i class="fa fa-male" aria-hidden="true"></i>Professor</span></li>
								<ul>
									...
									<li><a href="fct_reg.php"><i class="fa fa-user-plus" aria-hidden="true"></i> Register</a></li>
